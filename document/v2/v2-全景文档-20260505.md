...
> 覆盖版本：**v2.0 + v2.1 + v2.2 + v2.3 + v2.4**（v1 → v1.3 → v2.0 → v2.1 → v2.2 → v2.3 → v2.4 能力线）
...
**前端**：Vue 3 + TypeScript + Element Plus，SSE 流式呈现，暗夜模式持久化，欢迎建议卡片。
...
_文档版本：**v2 全景（v2.0 + v2.1 + v2.2 + v2.3 + v2.4 合并）** · 最后更新：2026-05-06_

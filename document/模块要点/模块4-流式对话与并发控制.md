...
// 模型窗口按 provider 取（DeepSeek/Ollama/DashScope 不同），支持 fish.llm.model-context-overrides
int contextWindow = fishLlmProperties.getEffectiveContextWindowTokens(activeModelName);

...
const welcomeLogoCanvas = ref<HTMLCanvasElement | null>(null)
...
function renderWelcomeLogo(): void {
  if (!welcomeLogoCanvas.value) return
  drawFishLogo(welcomeLogoCanvas.value, 56, dark.value ? '#fafafa' : '#0a0a0a')
}
  ...
  <div class="wrap" ref="scroller" @scroll="updateStick">
    <div class="messages-center">
      ...
      <div v-if="messages.length === 0" class="welcome">
        ...
        <canvas ref="welcomeLogoCanvas" class="logo" aria-hidden="true" />
